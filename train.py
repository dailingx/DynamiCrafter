...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="name run based on configs file name if true, else by whole path",
    )
    parser.add_argument(
        "--enable_tf32",
        type=str2bool,
